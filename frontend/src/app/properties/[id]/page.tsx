...
function PropertyDetailInner({ params }: { params: Promise<{ id: string }> }) {
    ...
    const displayProperty = {
        ...property,
        images: (property.images && property.images.length > 0) ? property.images : ["/placeholder-property.svg"],
        owner: {
            ...
            published: (property.publishedAt || property.createdAt)
                ? new Date(property.publishedAt || property.createdAt).toLocaleDateString("en-US", { month: "short", year: "numeric" })
                : "Recently",
        },
            ...
            <main className="flex-1 max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        <div className="grid grid-cols-2 gap-y-6 gap-x-6 px-2 sm:px-8 py-6 border-b border-t mb-8 sm:grid-cols-4 sm:items-center sm:gap-x-0 sm:justify-items-center">
                            ...
                            <div className="flex items-center gap-3 justify-self-end sm:justify-center sm:justify-self-center">
                        ...
                        <section className="mb-12">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                {(property.features ?? []).map((feature: string) => {
                                    const amenity = amenityById[feature as keyof typeof amenityById] as
                        ...
                        <div className="sticky top-24 p-8 rounded-3xl border shadow-xl bg-card">
                            ...
                            <div className="mt-8 pt-8 border-t flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-muted-foreground">Published {displayProperty.owner.published}</div>
                                </div>
                            </div>
