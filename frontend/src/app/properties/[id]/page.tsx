...
export default function PropertyDetail({ params }: { params: Promise<{ id: string }> }) {
    ...
    const displayProperty = {
        ...
        owner: {
            ...
            joined: property.owner?.createdAt ? new Date(property.owner.createdAt).toLocaleDateString('en-US', { month: 'short', year: 'numeric' }) : "Recently",
        },
                    ...
                    <div className="lg:col-span-2">
                        <div className="flex items-center gap-8 py-6 border-b border-t mb-8 overflow-x-auto no-scrollbar">
                            ...
                            <div className="flex flex-col items-center gap-1 min-w-[80px]">
                                ...
                                <span className="text-xs text-muted-foreground uppercase tracking-widest">Property</span>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-1">
                        <div className="sticky top-24 p-8 rounded-3xl border shadow-xl bg-card">
                            <div className="flex items-baseline justify-between mb-8">
                                <div>
                                    <span className="text-3xl font-black">${property.price.toLocaleString()}</span>
                            ...
                            <div className="mt-8 pt-8 border-t flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-muted-foreground">Joined {displayProperty.owner.joined}</div>
                                </div>
                            </div>
